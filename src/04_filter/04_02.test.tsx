...
import {demolishedHousesOnTheStreet, getBuildingsWithStaffcountMoreThan} from "./04_02";
...
test("buildings with correct staff count", () => {
    let buildings = getBuildingsWithStaffcountMoreThan(city.governmentBuildings, 500)
